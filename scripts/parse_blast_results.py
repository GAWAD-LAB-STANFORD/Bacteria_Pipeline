...
for blastn_json in blastn_jsons:
    ...
    try:
        ...
        pipeline_status_output += "\tError reading json file {} - this file is most likely empty\n".format(blastn_json)
...
pipeline_status_output = "{} processed of {} blast json result files found with {} prefix\n{}".format((len(blastn_jsons)-json_files_with_errors), len(blastn_jsons), blast_results_prefix, pipeline_status_output)
